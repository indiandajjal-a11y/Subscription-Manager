...
export class RealChargingSystemClient {
  ...
  async fetchSubscriberAccount(params) {
    ...
    return this._realFetchSubscriberAccount(params);
  }
  ...
  async attachOffer(params) {
    ...
    return this._realAttachOffer(params);
  }
  ...
  async removeOffer(params) {
    ...
    return this._realRemoveOffer(params);
  }
  ...
  async creditBack(params) {
    ...
    return this._realCreditBack(params);
  }
  ...
  async _realRemoveOffer(params) {
    // Similar implementation for removeOffer
    return this._mockRemoveOffer(params); // Placeholder
  }

  async _realCreditBack(params) {
    // Similar implementation for creditBack
    return this._mockCreditBack(params); // Placeholder
  }
}
